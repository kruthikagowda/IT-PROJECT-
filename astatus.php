...
<fieldset>
<br/>
<font size="5" color="teal"><b>STATUS</b></font>
<br/><br/><br/>
...
$sql = "SELECT id, name, check_in, check_out FROM outpass";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        echo "<br> id: ". $row["id"]. " <br> Name: ". $row["name"]. " <br> Check_in " . $row["ci"] . "<br> Check_out " . $row["co"];
    }
} else {
    echo "0 results";
}
